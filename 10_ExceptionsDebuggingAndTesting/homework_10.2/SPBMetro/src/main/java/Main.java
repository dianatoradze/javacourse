...
public class Main
{
        ...
        for(;;)
        {
           try {
               ...
               System.out.println("Длительность: " +
                ...
                logger.error(MarkerManager.getMarker("Exceptions"), exception.toString());
           }
        }
    }
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            logger.info(MarkerManager.getMarker("Search"), "Поиск станции " + line);
            Station station = stationIndex.getStation(line);
            if(station != null) {
                return station;
            }
            logger.warn(MarkerManager.getMarker("Errors"),"Станция не найдена " + line);
